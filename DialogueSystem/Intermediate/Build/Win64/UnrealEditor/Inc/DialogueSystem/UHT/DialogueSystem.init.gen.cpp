...
void EmptyLinkFunctionForGeneratedCodeDialogueSystem_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_DialogueSystem()
	{
		if (!Z_Registration_Info_UPackage__Script_DialogueSystem.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DialogueSystem_OnPickUp__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_DialogueSystem(Z_Construct_UPackage__Script_DialogueSystem, TEXT("/Script/DialogueSystem"), Z_Registration_Info_UPackage__Script_DialogueSystem, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xCCB1FDF6, 0x32D1BCC9));
